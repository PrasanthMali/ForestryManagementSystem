...
class CustomerUpdateById extends Component {
    ...
    constructor(props) {
        ...
        this.customerPassword = React.createRef();
    ...
    updateCustomer(e) {
        ...
        let payload = {
            ...
            customerPassword: this.customerPassword.current.value,
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input defaultValue={customer.customerPassword} type="text" ref={this.customerPassword} /></td>
                                    </tr>
                                    <tr>
