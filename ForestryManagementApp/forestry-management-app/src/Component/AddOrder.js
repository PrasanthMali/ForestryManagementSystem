...
class CreateOrderComponent extends Component {
    ...
    createOrder(e) {
        ...
        alert("Order Created Succesfully with number " + payload.orderNumber)
        ...
        return (
            <div>
                <div class="container">
                    ...
                    <input type="text" placeholder="Delivery Date" name="deliveryDate" id="deliveryDate" value={this.state.deliveryDate} onChange={this.handleInputChange}></input>
